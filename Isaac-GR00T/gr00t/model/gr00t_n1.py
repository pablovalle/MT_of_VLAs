...
class GR00T_N1_5(PreTrainedModel):
    ...
    def get_action(
        ...
        backbone_outputs = self.backbone(backbone_inputs)
        action_head_outputs, out_logits = self.action_head.get_action(backbone_outputs, action_inputs)
        self.validate_data(action_head_outputs, backbone_outputs, is_training=False)
        return action_head_outputs, backbone_outputs["logits"], out_logits
