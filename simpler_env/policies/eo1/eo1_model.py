...
class EOInference:
    def __init__(
        ...
        if policy_setup == "widowx_bridge":
            repo_id = "bridge_orig_1.0.0_lerobot"
            image_size = [256, 256]
            ...
            repo_id = "fractal20220817_data_0.1.0_lerobot"
            image_size = [320, 256]
        ...
        print(f"*** policy_setup: {policy_setup}, repo_id: {repo_id} ***")
        ...
        self.processor = AutoProcessor.from_pretrained(
            saved_model_path, trust_remote_code=True, local_files_only=True
        )
    ...
    def step(
        ...
        return (raw_action, state), action
